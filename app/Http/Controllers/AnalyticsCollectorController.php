...
/**
 * Public, fire-and-forget beacon for the visitor analytics system. Guests post
 * start/pageview/heartbeat/end events from the browser; the session and page
 * rows are upserted idempotently by their UUIDs so retries are safe.
 */
class AnalyticsCollectorController extends Controller
{
    public function __invoke(CollectAnalyticsRequest $request): JsonResponse
    {
        ...
        DB::transaction(function () use ($request, $data, $now, $duration, $pageDuration, $path, $client): void {
