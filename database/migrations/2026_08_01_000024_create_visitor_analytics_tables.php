...
return new class extends Migration
{
    ...
    {
        // One row per browser session on the public site. Unlike the portfolio
        // (which scopes by profile), Decore tracks the whole public site as a
        // single audience — no per-profile FK is needed.
