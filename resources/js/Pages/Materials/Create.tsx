...
export default function Create({
    ...
    return (
        <AuthenticatedLayout>
            ...
            <PageHeader title="New material" description="Add a product to the catalog. Costs stay visible only to finance roles." />
                ...
                <form onSubmit={submit} className="space-y-5">
                    <div className="grid gap-5 sm:grid-cols-2">
                        ...
                        <FormField label="SKU" required error={errors.sku} htmlFor="sku">
                            <TextInput id="sku" value={data.sku} onChange={(e) => setData('sku', e.target.value)} required placeholder="e.g. WP-2200" />
                        </FormField>
                        ...
                        <FormField label="Selling price" required error={errors.selling_price} htmlFor="selling_price" hint="Prices are tax-exclusive.">
                            <CurrencyInput
                                id="selling_price"
                        ...
                        <FormField label="Default supplier cost" error={errors.default_supplier_cost} htmlFor="default_supplier_cost" hint="Finance roles only — recorded to cost history.">
                            <CurrencyInput
                    ...
                    <div className="flex items-center justify-end gap-3 border-t border-white/[0.06] pt-5">
                        <GlassButton href={route('materials.index')} variant="secondary">Cancel</GlassButton>
                        <PrimaryButton disabled={processing}>{processing ? 'Creating…' : 'Create material'}</PrimaryButton>
                    </div>
                </form>
            </GlassCard>
        </AuthenticatedLayout>
