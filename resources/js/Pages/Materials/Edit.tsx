...
export default function Edit({
    ...
    return (
        <AuthenticatedLayout>
            <Head title={t('materials.edit_title')} />

            <PageHeader title={t('materials.edit_title')} description={material.localized_name ?? material.name_en} />
            ...
            <GlassCard className="max-w-3xl p-8">
                <form onSubmit={submit} className="space-y-5">
                    <div className="grid gap-5 sm:grid-cols-2">
                        ...
                        <FormField label={t('materials.selling_price')} required error={errors.selling_price} htmlFor="selling_price">
                            <CurrencyInput
                                id="selling_price"
                        ...
                        {canManageCosts && (
                            <FormField label={t('materials.default_supplier_cost')} error={errors.default_supplier_cost} htmlFor="default_supplier_cost" hint={t('materials.cost_hint_edit')}>
                                <CurrencyInput
                    ...
                    <div className="flex items-center justify-end gap-3 border-t border-white/[0.06] pt-5">
                        <GlassButton href={route('materials.show', material.id)} variant="secondary">{t('common.cancel')}</GlassButton>
