                    ...
                    <div>
                        <p className="mt-2 text-sm text-white/70">
                            ...
                            <Link
                                ...
                                method="post"
                                as="button"
                                className="ms-1 rounded-full text-sm text-accent underline underline-offset-4 hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
                            >
                                {t('profile.resend_link')}
                            </Link>
                        </p>
